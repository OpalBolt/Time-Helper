...
def run_timew_command(args: List[str], check: bool = True) -> subprocess.CompletedProcess:
...
def entries_have_meaningful_difference(before: List[TimeEntry], after: List[TimeEntry]) -> bool:
