...
class WeekUtils:
    ...
    def get_week_start_date(week_offset: int, year: int) -> date:
        ...
        if year != target_week_start.year:
            ...
            current_week_number = (current_week_start - WeekUtils.get_week_start(date(today.year, 1, 1))).days // 7
            target_week_start = first_monday + timedelta(weeks=current_week_number + week_offset)
