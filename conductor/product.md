...
- **Customizable Reporting:** Generates formatted reports for standard weeks or custom date ranges with tag filtering. Supports terminal, Markdown, and CSV output formats.
