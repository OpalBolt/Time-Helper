...
def test_get_time_entries_filtering(temp_db):
    # Setup data
    entries = [
        TimeEntry(id=1, start="20230101T090000Z", end="20230101T100000Z", tags=["work"], annotation="Task 1", date=date(2023, 1, 1)),
        TimeEntry(id=2, start="20230101T100000Z", end="20230101T110000Z", tags=["meeting"], annotation="Meeting 1", date=date(2023, 1, 1)),
        TimeEntry(id=3, start="20230102T090000Z", end="20230102T100000Z", tags=["work"], annotation="Task 2", date=date(2023, 1, 2)),
        TimeEntry(id=4, start="20230102T100000Z", end="20230102T110000Z", tags=["personal"], annotation="Break", date=date(2023, 1, 2)),
    ]
    ...
    result_all = temp_db.get_time_entries(
        date(2023, 1, 1), 
        date(2023, 1, 2)
    )
